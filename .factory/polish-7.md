...
| F-7-2 | Version is `0.1.4`; Tauri bundles `build-provenance.json`, `latest.json` records the source commit, and the landing refuses a stale release. | `@claim:desktop-build-identity`; live `home-release-live-1366.png`; <https://github.com/B-Divyesh/sf-photo-upload-audit/releases/tag/v0.1.4>. |
